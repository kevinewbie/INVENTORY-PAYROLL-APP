...
<html>
    <head>
        ...
        <title>Sistem Informasi Harmoni</title>
		<link rel="icon" href="http://192.168.100.22/harmoni/assets/logo.png" sizes="16x16" type="image/png">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
			...
			<img src="http:/harmoni/assets/logo.png" alt="HGK" width="150" height="150"><br>
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>Harmoni</b> Graha Kreasi</a>
