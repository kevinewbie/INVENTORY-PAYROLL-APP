<div class="content-wrapper">
	...
	<table class='table table-bordered>'        
	    ...
	    <tr><td>Kd Tanah</td><td><?php echo $kd_tanah; ?></td></tr>
	    <tr><td>Nama Tanah</td><td><?php echo $nama_tanah; ?></td></tr>
	    <tr><td>Lokasi</td><td><?php echo $lokasi; ?></td></tr>
	    <tr><td>Asal</td><td><?php echo $asal; ?></td></tr>
	    <tr><td>Nomor Sertifikat</td><td><?php echo $nomor_sertifikat; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('asettanah') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>	</div>
</div>
</div>
